...
class Solution
{
    ...
    {
        //code here
        // apply here level order traversal
        ...
        while(que.size() > 0 && marker == true) {
            ...
            for(int i=0; i<level; i++) {
                ...
                if(curr.left != null && curr.left == node_to_find) marker = false;
                else if(curr.right != null && curr.right == node_to_find) marker = false;
                else {
                    if(curr.left != null)
                    que.add(curr.left);
                    if(curr.right != null)
